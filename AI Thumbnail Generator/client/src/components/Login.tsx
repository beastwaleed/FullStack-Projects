  ...
  return ( <>
    ...
    <div className="min-h-screen flex items-center justify-center">
      <form 
                ...
                <button type="submit" disabled={loading} className="mt-2 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-pink-500 transition disabled:opacity-50 disabled:cursor-not-allowed" >
