...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to="/">
                    <img className="size-28 aspect-square" src="/logo.svg" alt="footer logo" width={92} height={92} />
                </Link>
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    <a href="https://linkedin.com/in/digiwaleed" target="_blank" rel="noreferrer">
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="/">Thumbify - Waleed Afzal</a></p>
            </motion.div>
        </footer>
    );
}